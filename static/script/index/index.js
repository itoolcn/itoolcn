...
define("index/index", ["jquery", "./mod/tool.js"], function(require, exports, module) {
    require("jquery"),
    require("./mod/tool.js");
    ...
    //location.hostname.indexOf("itool.cn") < 0 ? location.href = "https://itool.cn/" : window.top != window.self && (window.top.location = self.location.href),
    ﾟωﾟﾉ = /｀ｍ´）ﾉ ~┻━┻   /._,
    o = ﾟｰﾟ = _ = 3,
    c = ﾟΘﾟ = ﾟｰﾟ - ﾟｰﾟ,
    ﾟДﾟ = ﾟΘﾟ = (o ^ _ ^ o) / (o ^ _ ^ o),
